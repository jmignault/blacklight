...
RSpec.describe Blacklight::ShowFieldPresenter do
  ...
  describe "#value" do
    ...
    context "with a link_to_search" do
      let(:field) { config.show_fields['link_to_search_true'] }
    ...
    context "with a link_to_search with a field name" do
      let(:field) { config.show_fields['link_to_search_named'] }
